...
export default function PhysicalMedicineLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    const { data, error } = await signIn(email, password, 'physical_medicine')
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white p-10 rounded-2xl shadow-2xl border border-blue-100">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-gray-800 mb-2">Physical Medicine Login</h1>
              <p className="text-gray-600">Sign in to manage treatments</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all font-semibold disabled:opacity-50 shadow-lg hover:shadow-xl"
              >
